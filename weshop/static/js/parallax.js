...
function fnLoad() {
	...
	var boxHeight = (windowHeight-48)>570 ? (windowHeight-48) : 570;
	...
	document.getElementsByTagName("body")[0].style.height = (line.lineHeight + 48) * line.scrollRatio + "px";
	...
	var speedTop = 800;
	var scale = (line.lineHeight + 48 - windowHeight)/((line.lineHeight + 48) * line.scrollRatio - windowHeight);
	...
	// 	dom: ".b4_fixed",
	// 	regions: [{
	// 		startTop: (page_3 + 800)/(line.lineHeight + 48 - windowHeight)*((line.lineHeight + 48) * line.scrollRatio - windowHeight),
	// 		endTop: page_5-800,
	// 		startCss: {
	// 			top: -100
	// 		},
	...
	// 	dom: ".b6_fixed",
	// 	regions: [{
	// 		startTop: (page_5 + 800)/(line.lineHeight + 48 - windowHeight)*((line.lineHeight + 48) * line.scrollRatio - windowHeight),
	// 		endTop: page_7-800,
	// 		startCss: {
	// 			top: -50
	// 		},
	...
	// 	dom: ".b7_fixed",
	// 	regions: [{
	// 		startTop: (page_6 + 800)/(line.lineHeight + 48 - windowHeight)*((line.lineHeight + 48) * line.scrollRatio - windowHeight),
	// 		endTop: page_7,
	// 		startCss: {
	// 			top: 0
	// 		},
	...
	function scrollFunc(e) {
		var e = e || event;
		var wrapTop = 48 - document.getElementById("wrapBox").offsetTop;
		var direct;
		var endWrapTop;
		...
		window.scroll(0, endWrapTop/(line.lineHeight + 48 - windowHeight)*((line.lineHeight + 48) * line.scrollRatio - windowHeight));
	}
	...
	window.onscroll = function() {
		...
		// }
		endTop = top;
		//$wrapBox.css({"top": -top2+48});
		var wrapTop = top*(line.lineHeight + 48 - windowHeight)/((line.lineHeight + 48) * line.scrollRatio - windowHeight);//内容改变top值

		//$wrapBox.css({"top": -wrapTop+48});
		$wrapBox.stop().animate({"top": -wrapTop+48}, 1300);//#wrap 滚动
		//$wrapBox.stop().animate({"top": -wrapTop+48},{queue:false, duration: 1100});
